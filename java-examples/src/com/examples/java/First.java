...
public class First {/*
	...
	public static void main(String args[]) {
		...
		System.setProperty("webdriver.gecko.driver",
				"D:\\Testing Material\\geckodriver-v0.21.0-win64\\geckodriver.exe");
		...
		// Use the linkText locator method to find the link and perform click
		// using click() method
		...
		// Locate the checkbox by cssSelector and check it using click()
		// function
